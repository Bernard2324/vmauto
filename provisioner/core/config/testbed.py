...
config = {}
config["SERVER"] = "vcenter.sub.example.com"
config["USERNAME"] = "sub\admin.user"
config["PASSWORD"] = "abc123"

config["ESX_HOST1"] = ""
config["ESX_HOST2"] = "192.168.1.122"
...
config["NFS_DATASTORE_NAME"] = "DS01"
...
config["DATACENTER2_NAME"] = "London"

config["VM_FOLDER1_NAME"] = "Sample_VM_Folder_1"
config["VM_FOLDER2_NAME"] = "Discovered VM machine"

config["CLUSTER1_NAME"] = "Cluster Host Node"

config["VDSWITCH1_NAME"] = "DSwitch1"
config["VDPORTGROUP1_NAME"] = "Static_Portgroup_on_DSwitch_1"

config["STDPORTGROUP_NAME"] = "VM Main Network"

# The main datacenter and datastore that will be used for the VM tests
config["VM_DATACENTER_NAME"] = config["DATACENTER002_NAME"]
config["VM_DATASTORE_NAME"] = config["DS01_DATASTORE_NAME"]

# GuestOS should be one of the enumeration values in com.vmware.vcenter.vm.GuestOS
config["VM_GUESTOS"] = "CENTOS"

config["VM_NAME_DEFAULT"] = "Sample_Default_VM_for_Simple_Testbed"
config["VM_NAME_BASIC"] = "Sample_Basic_VM_for_Simple_Testbed"
# config["VM_NAME_EXHAUSTIVE"] = "CompanyAuto"
...
config["ISO_DATASTORE_ROOT_PATH"] = config["BACKENDS_DATASTORE_ROOT_PATH"] + "/ISO2"
config["ISO_DATASTORE_PATH"] = config["ISO_DATASTORE_ROOT_PATH"] + "/CentOS-7-x86_64-DVD-1511.iso"
