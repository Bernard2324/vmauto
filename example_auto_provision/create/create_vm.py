...
# example_auto_provision

from example_auto_provision.core.vsphere.common.ssl_helper import get_unverified_session
from example_auto_provision.core.vsphere.common import cli
from example_auto_provision.core.vsphere.common import util
from example_auto_provision.core.vsphere.common.util import pp
from example_auto_provision.core.vsphere.vcenter.helper import network_helper
from example_auto_provision.core.vsphere.vcenter.helper import vm_placement_helper
from example_auto_provision.core.vsphere.vcenter.helper.vm_helper import get_vm
from example_auto_provision.core.vsphere.vcenter.setup import testbed
...
class CreateExhaustiveVM(object):
    ...
    def __init__(self, hostname, cpu, ram, disk, client=None, placement_spec=None,
        ...
        if not self.client:
            ...
            # args = util.process_cli_args(parser.parse_args())
            # if args.vm_name:
